                    	...
                    	<div class="text-center text-md-right">
                           	<ul class="header_list">
                                @guest
                                    ...
                                    <li class="d-none d-md-inline-block"><a href="{{ url('afiliacion') }}"><i class="fas fa-user-plus"></i> <span>Ser Distribuidor Autorizado</span></a></li>
                                @else
        	...
        	<div class="container">
                <nav class="navbar navbar-expand-lg"> 
                    <a class="navbar-brand" href="{{ url('/') }}">
                        <img class="logo_dark w-100 d-none d-md-block" src="{{ asset('assets/images/logo_dark.png') }}" style="max-width: 180px;" alt="Logotipo de Fiber Solutions" />
                        <img class="logo_dark w-100 d-block d-md-none" src="{{ asset('assets/images/logo_dark.png') }}" style="max-width: 110px;" alt="Logotipo de Fiber Solutions" />
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                                    ...
                                    <ul class="mega-menu d-lg-flex">
                                        ...
                                        <li class="mega-menu-col col-lg-3">
                                            <ul> 
                                                ...
                                                <li>
                                                    <a class="dropdown-header nav-link nav_item" href="{{ url('nuestras-categorias/' . $category->slug) }}">{{$category->name}}</a>
                                                </li>    
                                                @endforeach
                                            </ul>
                                        </li>
                            ...
                            <li><a class="nav-link nav_item d-list-item d-md-none" href="{{ url('afiliacion') }}">Ser Distribuidor autorizado</a></li> 
                    ...
                    <ul class="navbar-nav attr-nav align-items-center">
                        ...
                        <li class="dropdown cart_dropdown">
                            <a class="nav-link cart_trigger" href="#" data-toggle="dropdown">
                                <i class="linearicons-cart"></i><span class="cart_count">{{ Cart::count() }}</span>
                            </a>
    ...
    <footer class="footer_dark">
        <div class="footer_top">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="widget">
                            <ul class="contact_info contact_info_light">
                                <li>
                                    <i class="ti-email"></i>
                                    <a href="mailto:info@fibersolutions.shop">info@fibersolutions.com.ve</a>
                                </li>
                                <li>
                                    <i class="ti-mobile"></i>
                                    <p>+58 414-1107270</p>
                        ...
                        <div class="widget">
                            <ul class="social_icons contact_info_light">
                                <li><a href="https://www.instagram.com/fibersolutions.ve/" target="_blank"><i class="fab fa-instagram" style="font-size: 30px;"></i></a></li>
                                ...
                                <li><a href="https://www.tiktok.com/@fibersolutions.ve" target="_blank"><i class="fab fa-tiktok"  style="font-size: 30px;"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-sm-6">
                        <div class="widget">
                            ...
                            <ul class="widget_links">
                                ...
                                <li><a href="{{ url('nuestros-productos') }}">Tienda</a></li>
                                <li><a href="{{ url('nosotros') }}">Acerca De</a></li>
                                <li><a href="{{ url('contacto') }}">Contacto</a></li>
                                <li><a href="{{ url('carrito-de-compras') }}">Carrito de Compras</a></li>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-6">
                        <div class="widget">
                            <h6 class="widget_title">Nuestro Productos</h6>
                            <ul class="widget_links">
        ...
        <div class="bottom_footer border-top-tran">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p class="mb-md-0 text-center text-md-left">© {{ date('Y') }} Fiber Solutions | Desarrollada con ❤️ Por <a href="https://www.linkedin.com/in/hectordamas/" target="_blank">Héctor Damas</a> </p>
                    </div>
                </div>
            </div>
        </div>
